            ...
            <table class="layui-table">
                ...
                <tbody>
                  @foreach($data as $g)
                    <tr>
                        <td>
                            <input type="checkbox" value="{{$g->cate_id}}" name="all">
                        </td>
                        <td>
                            {{$g->cate_id}}
                        </td>
                        <td>
                            <a href="#">{{$g->_cate_name}}</a>
                        </td>
                        <td >
                            {{$g->cate_count}}
                        </td>
                        ...
                        <td class="td-manage">
                            ...
                            <a title="编辑" href="{{url('admin/cateedit',$g->cate_id)}}"
                            class="ml-5" style="text-decoration:none">
                                <i class="layui-icon">&#xe642;</i>
                            </a>
                            <a title="删除" href="{{url('admin/catedestroy', $g->cate_id)}}"
